...
/** @type {(pattern: import("../types/data").InputData.HourPattern) => (moment: luxon.DateTime) => boolean} */
...
/** @type {(patterns: (import("../types/data").InputData.HourPattern)[]) => (moment: luxon.DateTime) => boolean} */
...
/** @type {(patterns: (import("../types/data").InputData.DayPattern)[]) => (moment: luxon.DateTime) => boolean} */
